...
| `scope-change-rate` | totalIssues + changedIssues + changeRatio + bySprint (incl. issueDetails[]) + changedIssueKeys | issues dont description/estimation/sprint change après entrée en sprint; seuil similarité 0.85; non snapshotté |
